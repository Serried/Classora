...
function T_Kormoon() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch(`/api/me/teacher`, { headers: { Authorization: `Bearer ${token}` } }).then((r) => r.json()),
      fetch(`/api/me/teacher/classrooms`, { headers: { Authorization: `Bearer ${token}` } }).then((r) => r.json()),
      fetch(`/api/me/teacher/subjects`, { headers: { Authorization: `Bearer ${token}` } }).then((r) => r.json()),
    ])
